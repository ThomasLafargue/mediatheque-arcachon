...
OUTIL_SQL = {
    ...
    "description": (
        ...
        "FRÉQUENTATION -- DEUX SÉRIES PARALLÈLES (02/08/2026) : "
        "frequentation / frequentation_horaire = heures d'OUVERTURE au public "
        "uniquement (juillet-août lundi-samedi 10h-19h, reste de l'année "
        "mardi-samedi 10h-18h ; un jour absent = fermé au public, pas une "
        "donnée manquante) ; "
        ...
        "suit et compare depuis des années. "
