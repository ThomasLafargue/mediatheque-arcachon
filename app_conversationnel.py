...
OUTIL_SQL = {
    ...
    "description": (
        ...
        "fréquenté d'une journée donnée. IMPORTANT : depuis le 01/08/2026 ces "
        "deux tables ne contiennent QUE les heures d'ouverture au public "
        "(juillet-août lundi-samedi 10h-19h, reste de l'année mardi-samedi "
        "10h-18h) -- les passages hors ouverture (équipe, ménage, jours fermés) "
        "sont exclus au chargement. Un jour absent de la table = jour fermé au "
